...
public class BookStorage {
    ...
    public void initBooks() {
        ...
        this.books[0] = new Book("Object Oriented Programming using C#","Simon Kendal", 403, Book.BookCategory.Programming);
        this.books[1] = new Book("Java: Classes in Java Applications","David Etheridge", 118, Book.BookCategory.Design);
        this.books[2] = new Book("Object Oriented Programming using Java","Simon Kendal", 216, Book.BookCategory.Programming);
